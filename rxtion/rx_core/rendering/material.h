...
#define RXCORE_MATERIAL_CREATE_FROM_PROTOTYPE_OVERIDE(prototype, ...) rxcore_material_create(prototype, (gs_graphics_uniform_desc_t[]){__VA_ARGS__}, sizeof((gs_graphics_uniform_desc_t[]){__VA_ARGS__}) / sizeof(gs_graphics_uniform_desc_t))
#define RXCORE_MATERIAL_CREATE_FROM_PROTOTYPE(prototype) rxcore_material_create(prototype, NULL, 0)
#define RXCORE_MATERIAL_CREATE(...) rxcore_material_create((gs_graphics_uniform_desc_t[]){__VA_ARGS__}, sizeof((gs_graphics_uniform_desc_t[]){__VA_ARGS__}) / sizeof(gs_graphics_uniform_desc_t))
